...
//     let mut execution_queue =
//         for<'a, 'b> move |start_id: Option<ShortID>,
//                           stack: &'a mut dyn Stack,
//                           registry: &'b dyn Registry| {
//             // Hello!
//             async move { Ok(()) }
//         };

//     loop {
//         executor.execute_async(&mut execution_queue).await.unwrap();
